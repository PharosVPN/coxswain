...
// Argon2id parameters. Encoded into every hash so they can evolve.
const (
	argonTime    = 1
...
// HashPassword returns an Argon2id PHC-format hash of plain.
...
// VerifyPassword reports whether plain matches the encoded Argon2id hash. A
